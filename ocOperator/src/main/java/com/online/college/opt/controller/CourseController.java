...
import com.online.college.common.storage.FastDFSConfig;
...
public class CourseController {
	...
	private String FASTDFS_BASE_URL= FastDFSConfig.baseUrl;
	...
	@ResponseBody
	public String doMerge(Course entity,@RequestParam MultipartFile pictureImg) throws Exception{
		String key = null;
		String url = null;

		if (pictureImg != null) {
			 url = writeFile(pictureImg);
		}
